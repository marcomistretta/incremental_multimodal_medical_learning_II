...
if __name__ == '__main__':
    ...
    # XXX run
    CONTINUAL_LEARNING = "myCL"  # "myCL"  # "profCL"  # "profCL"  # None "myCL", "profCL"
    threshold = 0.9  # 6e-3
    ratio = True
    ...
    writer, class_names, train_loader, val_loader, test_loader, prompts = Trainer.preprocessing_class_incremental_one_class(
        loss_name,
        chex_competition,
        xrays_position,
        basic_prompts,
    ...
    for epoch in range(1, epochs + 1):
        ...
        last_batch = trainer.train_class_incremental(train_loader[epoch - 1], optimizer, criterion, epoch, basic_prompts,
                                                     tasks_order[epoch - 1], CONTINUAL_LEARNING,
        ...
        trainer.test(test_loader, optimizer, criterion, epoch, basic_prompts, epochs, mode="class",
